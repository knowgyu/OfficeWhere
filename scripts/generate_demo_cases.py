    ...
    versions = {
        ...
        3: {
            ...
            "rows": [
                ...
                ["품질 체계 개편", "박민수", 110000000, "재개", "승인 대기", "260524"],
            ],
        ...
        4: {
            ...
            "rows": [
                ...
                ["품질 체계 개편", "박민수", 115000000, "진행중", "정책 검토", "260531", "재개 후 예산 증액"],
...
def build_word_cases() -> None:
    documents = {
        ...
        2: {
            ...
            "rows": [("항목", "내용"), ("담당", "플랫폼팀"), ("승인", "완료"), ("품질", "추가 검토 필요")],
        },
        3: {
            "paragraphs": [
                "본 문서는 3차 검토본이다.",
                "예산 검토 결과를 반영했고 품질 검토 일정을 확정했다.",
                "운영 이관 체크리스트를 추가한다.",
            ],
            "rows": [("항목", "내용"), ("담당", "플랫폼팀"), ("승인", "조건부 승인"), ("품질", "검토 진행중"), ("운영", "체크리스트 작성")],
        },
        4: {
            "paragraphs": [
                "본 문서는 4차 릴리즈 후보이다.",
                "예산과 품질 검토가 완료되었고 운영 이관 준비를 시작한다.",
                "사용자 교육 일정이 추가되었다.",
            ],
            "rows": [("항목", "내용"), ("담당", "플랫폼팀"), ("승인", "완료"), ("품질", "완료"), ("운영", "이관 준비"), ("교육", "260524 예정")],
        },
    }
...
def build_manual_test_library() -> None:
    ...
    _save_word_document(
        ...
        [
            ...
            "본문만 검색으로 예산 조정, 품질 검토 같은 본문 키워드를 찾을 수 있다.",
            "품질 검토 항목이 추가되었고 사용자 테스트를 시작한다.",
        ],
        [("작성자", "운영팀"), ("상태", "검토 완료"), ("추가", "품질 검토 포함")],
    )
    _save_word_document(
