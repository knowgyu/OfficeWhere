    ...
    versions: dict[int, dict[str, Any]] = {
        ...
        4: {
            "rows": [
                ...
                ["Office 정합성 검사", "이영희", "92000000", "개선중", "변경 이력 표 보기 개선", "260517"],
...
def build_tutorial_library(target_dir: Path) -> int:
    ...
    ppt_versions = {
        ...
        5: [
            ("A 프로젝트 상태", ["변경 이력 표 보기 개선 완료", "릴리즈 후보 준비"]),
