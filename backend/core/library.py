    ...
    for folder_index, folder in enumerate(settings.watched_folders, start=1):
        ...
        try:
            ...
            log_index_perf(
                ...
                provider_status=getattr(scan_result, "provider_status", ""),
                provider_fallback_reason=getattr(scan_result, "provider_fallback_reason", ""),
                provider_raw_total=getattr(scan_result, "provider_raw_total", 0),
                provider_returned_count=getattr(scan_result, "provider_returned_count", 0),
                provider_timed_out=getattr(scan_result, "provider_timed_out", False),
                provider_fallback_ran=getattr(scan_result, "provider_fallback_ran", False),
