...
대상 폴더를 등록하면 Excel, Word, PowerPoint, Markdown, 텍스트 파일을 읽어 검색 색인을 만들고, 원본 문서는 복사하거나 수정하지 않습니다. 파일명뿐 아니라 문서 본문, Excel 셀, Word 문단/표, PowerPoint 슬라이드 내용까지 함께 찾을 수 있습니다.
